%初始解
result=[1,1;1,585;400,1;400,550];
...
while T_now>=T_min
    ...
    while state==0
        ...
        %扰动寻找下一个点
        while state_n==0
            result_tmp=result+random_Disturb(1,T_max,T_now,T_min,loc_max_change,loc_min_change);
            if isMatch_points(result_tmp,outline_loc)
                state_n=1;
            end
        end
        %计算能量变化
